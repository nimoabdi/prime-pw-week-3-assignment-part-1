...
let favoriteFoods = ['pasta', 'ice cream', 'chipotle', 'ramen']; 
...
console.log('Added chips to the end!!', favoriteFoods);
...
console.log('Removed the last variable',removedFoods);
...
console.log(`Added cookie to beginning: ${favoriteFoods}`);
